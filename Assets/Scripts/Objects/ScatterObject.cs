...
public class ScatterObject : MonoBehaviour
{
    ...
    private void DestroyMesh()
    {
        ...
        PartMesh mainPart = new PartMesh() {UV = originalMesh.uv,
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(ScatterObject original)
        {
            ...
            ScatterObject meshDestroy = GameObject.AddComponent<ScatterObject>();
